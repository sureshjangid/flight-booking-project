            ...
            <main>
                <section className="site-banner position-relative inside-banner-two">
                    ...
                    <div className="banner-content">
                        <h1 className="banner-title">FAQs PAGE</h1>
                    </div>
                </section>
                    ...
                    <div className="container">
                        <div className="why-choose-content">
                            <ul className="list-unstyled mb-0">
                                <li>
                                    <h4 className="small-title">FAQs PAGE</h4>
                                    <p>FAQs PAGEFAQs PAGEFAQs PAGEFAQs PAGEFAQs PAGEFAQs PAGEFAQs PAGEFAQs PAGEFAQs PAGEFAQs PAGE(“us”, “we” or “our” as the context requires) provides online travel search services (including flight, hotel and car hire price comparison) and other travel related services (the “Services”) to travellers throughout the world via our websites (the “Platforms”).
                                    </p>
